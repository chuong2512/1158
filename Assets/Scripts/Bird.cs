...
public class Bird : MonoBehaviour
{
	...
	{
		Vector3 result;
		result.x = Mathf.Sin(this.angleX * 0.0174532924f) * this.amplitudeX;
		result.y = Mathf.Sin(this.angleY * 0.0174532924f) * this.amplitudeY;
		result.z = Mathf.Sin(this.angleZ * 0.0174532924f) * this.amplitudeZ;
		return result;
	}
}
